...
public class RouteController {
   ...
   *                   to find information about.
   *
   * @param count A {@code int} representing the enrolled student count for a particular course.
   *
   * @return           A {@code ResponseEntity} object indicating that the enrolled student count
   *                   was successfully set and an HTTP 200 response or, an appropriate message
   *                   indicating the proper response.
   */
